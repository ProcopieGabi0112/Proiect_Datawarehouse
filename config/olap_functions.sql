...
CREATE OR REPLACE FUNCTION dw_manager.gaseste_id_perioada_OLAP(p_zi_din_an_inceput perioada_rezervare_OLAP.zi_din_an_inceput%TYPE, p_an_inceput perioada_rezervare_OLAP.an_inceput%TYPE,
...
CREATE OR REPLACE FUNCTION dw_manager.gaseste_id_moment_efectuare_OLAP(p_zi_din_an moment_efectuare_rezervare_OLAP.zi_din_an%TYPE, p_an moment_efectuare_rezervare_OLAP.an%TYPE)
...
CREATE OR REPLACE FUNCTION dw_manager.gaseste_id_tip_camera_OLAP(p_nr_paturi_duble tip_camera_OLAP.nr_paturi_duble%TYPE, p_nr_paturi_simple tip_camera_OLAP.nr_paturi_duble%TYPE,
...
CREATE OR REPLACE FUNCTION dw_manager.gaseste_id_tip_client_OLAP (p_varsta tip_client_OLAP.varsta%TYPE, p_gen tip_client_OLAP.gen%TYPE,p_stare_civila tip_client_OLAP.stare_civila%TYPE)
