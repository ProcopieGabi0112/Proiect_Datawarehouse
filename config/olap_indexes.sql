...
ON dw_manager.rezervare_camera_OLAP(id_rezervare);

CREATE BITMAP INDEX luna_an_efectuare_bjindex_OLAP
ON dw_manager.moment_efectuare_OLAP(moment_efectuare_OLAP.luna,moment_efectuare_OLAP.an)
...
ON dw_manager.hotel_OLAP(hotel.localitate,hotel.pozitie)
...
ON dw_manager.tip_camera_OLAP(tip_camera_OLAP.nr_paturi_duble,tip_camera_OLAP.nr_paturi_simple)
